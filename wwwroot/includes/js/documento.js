...
function funImprimirComprobantePdf(pValor) {
  if (isArchivoGenerado) {
    ...
    if (isLlamarArchivoPDF) {
      ...
      setTimeout(function () {
        IsExistenciaComprobante(nombreArchivoPDF, "OnCallBackComprobantePDF");
      }, 10);
    }
    return false;
  }
...
function OnCallBackComprobantePDF(args) {
  if (args.toUpperCase() == "TRUE") {
    ...
    window.open(
      "../../servicios/generar_archivoPdf.aspx?tipo=" +
        objTipoDocumento +
        "&nro=" +
        nroDocumento,
      "_parent"
    ...
    if (contadorPDF <= 300) {
      ...
      //$('#imgPdf').attr('src', '../../img/iconos/PDF.png');
      ocultarLoaderBotonDescarga("0");
      mensaje_informacion_generico(
        objMensajeNoSePudoDescargarArchivoInténteloNuevamente
      );
    }
    contadorPDF++;
  }
...
function funImprimirComprobantePdf_trz(pValor) {
  if (isArchivoGenerado_trz) {
    ...
    if (isLlamarArchivoPDF_trz) {
      ...
      setTimeout(function () {
        IsExistenciaComprobante(
          nombreArchivoPDF_trz,
          "OnCallBackComprobantePdf_trz"
        );
      }, 10);
    }
    return false;
...
function CargarHtmlResumen() {
  if (objDocumento != null) {
    ...
    var strHtmlDescarga = "";
    strHtmlDescarga +=
      '<div class="load_gif" id="btn_to_hide-' +
      "0" +
      '-img"></div><a id="btn_to_hide-' +
      "0" +
      '" class="btn_download float-right" href="' +
      httpRaiz +
      "servicios/generar_archivoPdf.aspx?tipo=" +
      objTipoDocumento +
      "&nro=" +
      objDocumento.Numero +
      '"  onclick="return funImprimirComprobantePdf(' +
      "'" +
      objDocumento.Numero +
      "'" +
      ');" >DESCARGAR</a>';
    ...
    strHtmlCabecera +=
      '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>N&uacute;mero:</span>' +
      objDocumento.Numero +
      "</div>";
    strHtmlCabecera +=
      '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>Sem:</span>' +
      objDocumento.NumeroSemana +
      "</div>";
    strHtmlCabecera +=
      '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>Desde:</span>' +
      objDocumento.PeriodoDesdeToString +
      "</div>";
    strHtmlCabecera +=
      '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>Hasta:</span>' +
      objDocumento.PeriodoHastaToString +
      "</div>";
    var strTotalResumen = "&nbsp;";
    if (isNotNullEmpty(objDocumento.TotalResumen)) {
      strTotalResumen =
        "$&nbsp;" +
        FormatoDecimalConDivisorMiles(objDocumento.TotalResumen.toFixed(2));
    }
    strHtmlCabecera +=
      '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>Total:</span>' +
      strTotalResumen +
      "</div>";
    ...
    strHtml +=
      '<table class="footable table tbl_ch table-stripped" data-empty="No hay informacion disponible" width="100%" align="center" cellspacing="1" cellpadding="5" border="0">';
    strHtml += "<thead>";
    strHtml += "<tr>";
    strHtml +=
      '<th class="col-lg-1 col-md-1 col-sm-1 col-xs-2 text-center no-padding" >';
    strHtml += '<table  width="100%" cellpadding="0" cellspacing="0">';
    strHtml +=
      '<tr><td class="col-lg-12 text-center">&nbsp;<div class="clear5"></div></td></tr>';
    strHtml +=
      '<tr class="tr_thead"><td class="col-lg-12 text-center">D&iacute;a</td></tr>';
    strHtml += "</table>";
    //strHtml += '<span class="thd_letra_chica visible-xs">D&iacute;a</span>';
    strHtml += "</th>";
    strHtml +=
      '<th class="col-lg-3 col-md-3 col-sm-3 col-xs-5 text-center no-padding" data-breakpoints="xs" >';
    strHtml +=
      '<table class="hidden-xs" width="100%" cellpadding="0" cellspacing="0">';
    strHtml +=
      '<tr><td class="col-lg-12 text-center">&nbsp;<div class="clear5"></div></td></tr>';
    strHtml +=
      '<tr class="tr_thead"><td class="col-lg-12 text-center">Descripci&oacute;n</td></tr>';
    strHtml += "</table>";
    strHtml +=
      '<span class="thd_letra_chica visible-xs">Descripci&oacute;n</span>';
    strHtml += "</th>";
    strHtml +=
      '<th class="col-lg-2 col-md-2 col-sm-2 col-xs-6 text-center no-padding">';
    strHtml += '<table  width="100%" cellpadding="0" cellspacing="0">';
    strHtml +=
      '<tr><td class="col-lg-12 text-center">&nbsp;<div class="clear5"></div></td></tr>';
    strHtml +=
      '<tr class="tr_thead"><td class="col-lg-12 text-center">Tipo Comprobante</td></tr>';
    strHtml += "</table>";
    //strHtml += '<span class="thd_letra_chica visible-xs">Tipo</span>';
    strHtml += "</th>";
    strHtml +=
      '<th class="col-lg-2 col-md-2 col-sm-2 col-xs-4 text-center no-padding">';
    strHtml += '<table width="100%" cellpadding="0" cellspacing="0">';
    strHtml +=
      '<tr><td class="col-lg-12 text-center">&nbsp;<div class="clear5"></div></td></tr>';
    strHtml +=
      '<tr class="tr_thead"><td class="col-lg-12 text-center no_brd-r">Importe</td></tr>';
    strHtml += "</table>";
    strHtml += "</th>";
    strHtml += "</tr>";
    strHtml += "</thead>";
    ...
    for (var i = 0; i < objDocumento.lista.length; i++) {
      if (
        isVizualizarDetalleResumenLlendoDescripcion(
          objDocumento.lista[i].Descripcion
        )
      ) {
        ...
        var vtoTexto = "";
        if (
          objDocumento.lista[i].Descripcion.toUpperCase().search(
            "TOTAL DE UNIDADES"
          ) > -1
        ) {
        ...
        if (
          ...
          var FechaVtoString =
            ...
            aDesc[1] +
            "/" +
            aDesc[0].substr(aDesc[0].length - 2);
          vtoTexto =
            aDesc[0].substr(aDesc[0].length - 2) +
            "/" +
            aDesc[1] +
            ...
            aDesc[2].substr(0, 4) +
            " | $ " +
            aDesc[2].substr(5, aDesc[2].lenght).trim();
          //ObtenerVtosResumenes(objDocumento.Numero, FechaVtoString);
          verVtos =
            '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i data-toggle="tooltip" title="Ver Detalle de Vencimiento" class="fa fa-search" style="cursor: pointer;" onclick="ObtenerVtosResumenes(\'' +
            objDocumento.Numero +
            "','" +
            FechaVtoString +
            "')\"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
        ...
        strHtml +=
          '<td class="col-lg-1 col-md-1 col-sm-1 col-xs-2  text-center">';
        strHtml += objDocumento.lista[i].Dia;
        strHtml += "</td>";
        strHtml +=
          '<td class="col-lg-7 col-md-7 col-sm-7 col-xs-12 text-center">';
        strHtml +=
          ObtenerLinkDeDocumentoDesdeStr(objDocumento.lista[i].Descripcion) +
          verVtos;
        strHtml += "</td>";
        strHtml +=
          '<td class="col-lg-2 col-md-2 col-sm-2 col-xs-6 text-center c_to_l-xs">';
        ...
        strHtml += "</td>";
        strHtml +=
          '<td class="col-lg-2 col-md-2 col-sm-2 col-xs-4 text-right">';
        var strImporte = "&nbsp;";
        if (isNotNullEmpty(objDocumento.lista[i].Importe)) {
          strImporte =
            ...
            FormatoDecimalConDivisorMiles(
              parseFloat(
                objDocumento.lista[i].Importe.replace(",", ".")
              ).toFixed(2)
            );
        }
    ...
    strHtml +=
      '<table class="footable table table-stripped" data-empty="No hay informacion disponible" width="100%" align="center" cellspacing="1" cellpadding="5" border="0">';
    strHtml += "<tbody>";
    strHtml +=
      '<tr><td  class="text-center"><p class="color_red">' +
      objMensajeNoEncontrado +
      "</p></td></tr>";
    strHtml += "</tbody>";
    strHtml += "</table>";
    $("#divContenedorDocumento").html(strHtml);
...
function CargarHtmlFactura() {
  if (objDocumento != null) {
    ...
    $("#divContenedorDocumentoCabecera").append(
      CargarHtmlCabecera_Generico(objDocumento)
    );
    ...
    strHtml +=
      '<tr><td class="col-lg-12 text-center">&nbsp;<div class="clear5"></div></td></tr>';
    strHtml +=
      '<tr class="tr_thead"><td class="col-lg-12 text-center">Troquel</td></tr>';
    strHtml += "</table>";
    strHtml += "</th>";

    strHtml +=
      '<th class="col-lg-3 col-md-3 col-sm-3 col-xs-10 text-center no-padding">';
    strHtml += '<table width="100%" cellpadding="0" cellspacing="0">';
    strHtml +=
      '<tr><td class="col-lg-12 text-center">&nbsp;<div class="clear5"></div></td></tr>';
    strHtml +=
      '<tr class="tr_thead"><td class="col-lg-12 text-center">Producto</td></tr>';
    strHtml += "</table>";
    strHtml += "</th>";

    strHtml +=
      '<th class="col-lg-1 col-md-1 col-sm-1 col-xs-1 text-center no-padding" data-breakpoints="xs">';
    strHtml +=
      '<table class="hidden-xs" width="100%" cellpadding="0" cellspacing="0">';
    strHtml +=
      '<tr><td class="col-lg-12 text-center">&nbsp;<div class="clear5"></div></td></tr>';
    strHtml +=
      '<tr class="tr_thead"><td class="col-lg-12 text-center">Caracter&iacute;sticas</td></tr>';
    strHtml += "</table>";
    strHtml +=
      '<span class="thd_letra_chica visible-xs">Caracter&iacute;sticas</span>';
    strHtml += "</th>";
    ...
    strHtml +=
      '<tr><td class="col-lg-12 text-center">&nbsp;<div class="clear5"></div></td></tr>';
    strHtml +=
      '<tr class="tr_thead"><td class="col-lg-12 text-center">Cantidad</td></tr>';
    strHtml += "</table>";
    strHtml += '<span class="thd_letra_chica visible-xs">Cantidad</span>';
    strHtml += "</th>";

    strHtml +=
      '<th class="col-lg-2 col-md-2 col-sm-2 col-xs-1 text-center no-padding" data-breakpoints="xs">';
    strHtml +=
      '<table class="hidden-xs" width="100%" cellpadding="0" cellspacing="0">';
    strHtml +=
      '<tr><td class="col-lg-12 text-center">&nbsp;<div class="clear5"></div></td></tr>';
    strHtml +=
      '<tr class="tr_thead"><td class="col-lg-12 text-center">Precio P&uacute;blico</td></tr>';
    strHtml += "</table>";
    strHtml +=
      '<span class="thd_letra_chica visible-xs">Precio P&uacute;blico</span>';
    strHtml += "</th>";
    ...
    strHtml +=
      '<tr><td class="col-lg-12 text-center">&nbsp;<div class="clear5"></div></td></tr>';
    strHtml +=
      '<tr class="tr_thead"><td class="col-lg-12 text-center">Precio Unit.</td></tr>';
    strHtml += "</table>";
    strHtml +=
      '<span class="thd_letra_chica visible-xs">Precio Unitario</span>';
    strHtml += "</th>";

    strHtml +=
      '<th class="col-lg-2 col-md-2 col-sm-2 col-xs-2 text-center no-padding" data-breakpoints="xs">';
    strHtml +=
      '<table class="hidden-xs" width="100%" cellpadding="0" cellspacing="0">';
    strHtml +=
      '<tr><td class="col-lg-12 text-center">&nbsp;<div class="clear5"></div></td></tr>';
    ...
    if (objDocumento.lista != null) {
      for (var i = 0; i < objDocumento.lista.length; i++) {
        if (
          ...
          strHtml +=
            '<td class="col-lg-1 col-md-1 col-sm-1 col-xs-3 text-center">';
          strHtml += objDocumento.lista[i].Troquel;
          strHtml += "</td>";
          strHtml +=
            '<td class="col-lg-2 col-md-2 col-sm-2 col-xs-9 text-left">';
          strHtml += objDocumento.lista[i].Descripcion;
          strHtml += "</td>";
          strHtml +=
            '<td class="col-lg-1 col-md-1 col-sm-1 col-xs-12 c_to_l-xs">';
          ...
          if (isNotNullEmpty(objDocumento.lista[i].PrecioPublico)) {
            strPrecioPublico =
              ...
              FormatoDecimalConDivisorMiles(
                parseFloat(
                  objDocumento.lista[i].PrecioPublico.replace(",", ".")
                ).toFixed(2)
              );
          }
          ...
          if (isNotNullEmpty(objDocumento.lista[i].PrecioUnitario)) {
            strPrecioUnitario =
              ...
              FormatoDecimalConDivisorMiles(
                parseFloat(
                  objDocumento.lista[i].PrecioUnitario.replace(",", ".")
                ).toFixed(2)
              );
          }
...
function CargarHtmlNotaCredito() {
  if (objDocumento != null) {
    ...
    if (isMostrarTodo) {
      ...
      strHtml +=
        '<th class="col-lg-9 col-md-9 col-sm-9 col-xs-9 text-center no-padding">';
      strHtml += '<table  width="100%" cellpadding="0" cellspacing="0">';
      strHtml +=
        '<tr><td class="col-lg-12 text-center">&nbsp;<div class="clear5"></div></td></tr>';
      strHtml +=
    ...
    if (isMostrarTodo) {
      ...
      strHtml +=
        '<tr><td class="col-lg-12 text-center">&nbsp;<div class="clear5"></div></td></tr>';
      strHtml +=
        '<tr class="tr_thead"><td class="col-lg-12 text-center">Precio Público</td></tr>';
      strHtml += "</table>";
      strHtml +=
        '<span class="thd_letra_chica visible-xs">Precio Público</span>';
      strHtml += "</th>";
    }
    if (isMostrarTodo) {
      strHtml +=
      ...
      strHtml +=
        '<tr><td class="col-lg-12 text-center">&nbsp;<div class="clear5"></div></td></tr>';
      strHtml +=
        '<tr class="tr_thead"><td class="col-lg-12 text-center">Precio Unitario</td></tr>';
      strHtml += "</table>";
      strHtml +=
        '<span class="thd_letra_chica visible-xs">Precio Unitario</span>';
      strHtml += "</th>";
    ...
    if (isMostrarTodo) {
      ...
      strHtml +=
        '<th class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-center no-padding">';
      strHtml += '<table width="100%" cellpadding="0" cellspacing="0">';
    }
    strHtml +=
      '<tr><td class="col-lg-12 text-center">&nbsp;<div class="clear5"></div></td></tr>';
    strHtml +=
      '<tr class="tr_thead"><td class="col-lg-12 text-center">Importe</td></tr>';
    strHtml += "</table>";
    if (isMostrarTodo) {
      strHtml += '<span class="thd_letra_chica visible-xs">Importe</span>';
    }
    ...
    if (objDocumento.lista != null) {
      for (var i = 0; i < objDocumento.lista.length; i++) {
        if (
          ...
          if (isMostrarTodo) {
            strHtml +=
              '<td class="col-lg-1 col-md-1 col-sm-1 col-xs-2 text-center c_to_l-xs">';
            strHtml += objDocumento.lista[i].Troquel;
            strHtml += "</td>";
          }
          if (isMostrarTodo) {
            strHtml +=
              '<td class="col-lg-2 col-md-2 col-sm-2 col-xs-10 text-left">';
          } else {
            strHtml +=
              '<th class="col-lg-9 col-md-9 col-sm-9 col-xs-9 text-left">';
          }
          strHtml += objDocumento.lista[i].Descripcion;
          strHtml += "</td>";
          if (isMostrarTodo) {
...
function CargarHtmlCabecera_Generico(objDocumento) {
  ...
  if (objTipoDocumento == "FAC" && objDocumento.FacturaTrazable) {
    strHtmlDescarga +=
      ...
      "&nro=" +
      objDocumento.Numero +
      '"  onclick="return funImprimirComprobantePdf_trz(' +
      "'" +
      objDocumento.NumeroRemito +
      "'" +
      ');" data-toggle="tooltip" data-placement="bottom" title="Descarga pdf trazable" data-original-title="Descarga pdf trazable">PDF TRZ</a>';
  }
  strHtmlDescarga +=
    '<a class="btn_download float-right" href="' +
    httpRaiz +
    "servicios/generar_archivoPdf.aspx?tipo=" +
    objTipoDocumento +
    "&nro=" +
    ...
    objDocumento.Numero +
    "'" +
    ');"  data-toggle="tooltip" data-placement="bottom" title="Descargar en pdf" data-original-title="Descargar en pdf">PDF</a>';
  if (objTipoDocumento == "FAC") {
    strHtmlDescarga +=
      ...
      '"  class="btn_download float-right" href="' +
      httpRaiz +
      "servicios/generar_factura_csv?factura=" +
      objDocumento.Numero +
      '" data-toggle="tooltip" data-placement="bottom" title="Descargar en csv" data-original-title="Descargar en csv">CSV</a>';
    strHtmlDescarga +=
      '<div class="load_gif" id="btn_to_hide-' +
      "0" +
      '-img"></div><a id="btn_to_hide-' +
      ...
      '"  class="btn_download float-right" href="' +
      httpRaiz +
      "servicios/generar_archivo.aspx?factura=" +
      objDocumento.Numero +
      '" data-toggle="tooltip" data-placement="bottom" title="Descargar en txt" data-original-title="Descargar en txt">TXT</a>';
    strHtmlDescarga +=
      '<a class="btn_download float-right" href="../../archivos/Diseño TXT Factura.pdf" target="_blank" data-toggle="tooltip" data-placement="bottom" title="Descargar en formato txt" data-original-title="Descargar en formato txt">FORMATO TXT</a>';
  }
  strHtmlDescarga +=
    '<div class="float-right pad_7 hidden-xs">Descargas:</div>';
  $("#divContenedorDocumentoDescarga").append(strHtmlDescarga);
  ...
  strHtml +=
    ...
    "</div>";
  strHtml +=
    '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>Remito/OP:</span>' +
    objDocumento.NumeroRemito +
    "</div>";
  strHtml +=
    '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>Fecha:</span>' +
    objDocumento.FechaToString +
    "</div>";
  var aFecha = objDocumento.FechaToString.split("/");
  var FechaFac = new Date(
    Number(aFecha[2]),
    Number(aFecha[1]) - 1,
    Number(aFecha[0])
  );
  ...
  strHtml +=
    '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>Semana:</span>' +
    NroSemana +
    "</div>";
  var strMontoTotal = "&nbsp;";
  if (isNotNullEmpty(objDocumento.MontoTotal)) {
    strMontoTotal =
      "$&nbsp;" +
      FormatoDecimalConDivisorMiles(objDocumento.MontoTotal.toFixed(2));
  }
  strHtml +=
    '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>Total:</span>' +
    strMontoTotal +
  ...
  if (isMostrarEnCabezadoTodo) {
    ...
    if (isNotNullEmpty(objDocumento.MontoExento)) {
      strMontoExento =
        "$&nbsp;" +
        FormatoDecimalConDivisorMiles(objDocumento.MontoExento.toFixed(2));
    }
    strHtml +=
      '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>Monto Exento:</span>' +
      strMontoExento +
      "</div>";
  }
  if (isMostrarEnCabezadoTodo) {
    ...
    if (isNotNullEmpty(objDocumento.MontoGravado)) {
      strMontoGravado =
        "$&nbsp;" +
        FormatoDecimalConDivisorMiles(objDocumento.MontoGravado.toFixed(2));
    }
    strHtml +=
      '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>Monto Gravado:</span>' +
      strMontoGravado +
      "</div>";
  }
  if (isMostrarEnCabezadoTodo) {
    ...
    if (isNotNullEmpty(objDocumento.MontoIvaInscripto)) {
      strMontoIvaInscripto =
        "$&nbsp;" +
        FormatoDecimalConDivisorMiles(
          objDocumento.MontoIvaInscripto.toFixed(2)
        );
    }
    strHtml +=
      '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>IVA Inscripto:</span>' +
      strMontoIvaInscripto +
      "</div>";
  }
  if (isMostrarEnCabezadoTodo) {
    ...
    if (isNotNullEmpty(objDocumento.MontoIvaNoInscripto)) {
      strMontoIvaNoInscripto =
        "$&nbsp;" +
        FormatoDecimalConDivisorMiles(
          objDocumento.MontoIvaNoInscripto.toFixed(2)
        );
    }
    strHtml +=
      '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>IVA No Inscripto:</span>' +
      strMontoIvaNoInscripto +
      "</div>";
  }
  ...
  if (isNotNullEmpty(objDocumento.MontoPercepcionDGR)) {
    strMontoPercepcionDGR =
      "$&nbsp;" +
      FormatoDecimalConDivisorMiles(objDocumento.MontoPercepcionDGR.toFixed(2));
  }
  strHtml +=
    '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>Percepci&oacute;n DGR:</span>' +
    strMontoPercepcionDGR +
    "</div>";
  if (objTipoDocumento == "FAC") {
    // Inicio parte nueva
    ...
    if (isNotNullEmpty(objDocumento.MontoPercepcionMunicipal)) {
      strMontoPercepcionMunicipal =
        "$&nbsp;" +
        FormatoDecimalConDivisorMiles(
          objDocumento.MontoPercepcionMunicipal.toFixed(2)
        );
    }
    strHtml +=
      '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>Percepci&oacute;n Municipal:</span>' +
      strMontoPercepcionMunicipal +
      "</div>";
    // Fin parte nueva
  }
...
function CargarHtmlCabeceraPendienteDeFacturar(objDocumento) {
  ...
  strHtml +=
    '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>Fecha:</span>' +
    objDocumento.FechaIngresoToString +
    "</div>";
  var strMontoTotal = "&nbsp;";
  if (isNotNullEmpty(objDocumento.MontoTotal)) {
    strMontoTotal =
...
function CargarHtmlPendienteDeFacturar() {
  if (objDocumento != null) {
    ...
    $("#divContenedorDocumentoCabecera").append(
      CargarHtmlCabeceraPendienteDeFacturar(objDocumento)
    );
    ...
    if (objDocumento.Items != null) {
      for (var i = 0; i < objDocumento.Items.length; i++) {
        if (
          isVizualizarDetalleResumenLlendoDescripcion(
            objDocumento.Items[i].NombreObjetoComercial
          )
        ) {
          var strHtmlColorFondo = "wht";
          if (i % 2 != 0) {
          ...
          strHtml += '<tr class="' + strHtmlColorFondo + '">';
          strHtml +=
            '<td class="col-lg-9 col-md-9 col-sm-9 col-xs-9 text-left">';
...
function CargarHtmlCabeceraObraSocialCliente(objDocumento) {
  ...
  strHtml += '<div class="div_cont_ctacte">';
  strHtml +=
    '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>Número:</span>' +
  ...
  strHtml += '<div class="clear10 visible-lg"></div>';
  strHtml +=
    '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>Nombre Plan:</span>' +
    objDocumento.NombrePlan +
    "</div>";
  strHtml +=
    '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>Número Planilla:</span>' +
    objDocumento.NumeroPlanilla +
    "</div>";
  strHtml +=
    '<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 doc_info"><span>Destinatario:</span>' +
    objDocumento.Destinatario +
    "</div>";
  strHtml += '<div class="clear0"></div>';
  strHtml += "</div>";
  return strHtml;
...
function CargarHtmlObraSocialCliente() {
  if (objDocumento != null) {
    ...
    $("#divContenedorDocumentoCabecera").append(
      CargarHtmlCabeceraObraSocialCliente(objDocumento)
    );
    ...
    strHtml +=
      '<tr><td class="col-lg-12 text-center">&nbsp;<div class="clear5"></div></td></tr>';
    strHtml +=
      '<tr class="tr_thead"><td class="col-lg-12 text-center">Descripcion</td></tr>';
    strHtml += "</table>";
    strHtml += "</th>";
    strHtml +=
      '<th class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-center no-padding">';
...
function MostrarVencimientos(cVencimientosResumen) {
  var total = 0;
  var html =
    '<table with="100%" class="table table-striped" style="background: #e1e1e1;">';
  html += "<thead>";
  html +=
    '<tr style="height: 40px;"><th class="text-center">Comprobante<br></th><th class="text-center">Número<br></th><th class="text-center">Fecha<br></th><th class="text-center">Importes<br></th></tr></thead>';
  ...
  for (var i = 0; i < cVencimientosResumen.length; i++) {
    ...
    html +=
      '<td class="text-center"><a href="Documento?t=' +
      cVencimientosResumen[i].Tipo +
      "&id=" +
      cVencimientosResumen[i].NumeroComprobante +
      '" >' +
      cVencimientosResumen[i].NumeroComprobante +
      "</a></td>";
    html +=
      '<td class="text-center">' +
      cVencimientosResumen[i].FechaToString +
      "</td>";
    html +=
      '<td class="text-right">$ ' +
      FormatoDecimalConDivisorMiles(
        Number(cVencimientosResumen[i].Importe).toFixed(2)
      ) +
      "</td>";
    html += "</tr>";
  ...
  strHtml +=
    '<h5 style="color: steelblue;">Comprobantes con vencimiento ' +
    cVencimientosResumen[0].FechaVencimientoToString +
    "<br>Total: $ " +
    FormatoDecimalConDivisorMiles(Number(total).toFixed(2)) +
    "</h5>";
  strHtml += "</div>";
  strHtml +=
