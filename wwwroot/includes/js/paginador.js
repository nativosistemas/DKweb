...
function GenerarPaginador() {
  ...
  if (cantPaginaTotal > 1) {
    ...
    // Anterior
    strHtmlPag +=
      '<li ><a data-toggle="tooltip" data-placement="bottom" title="Inicio" onclick="clickAvanceRetrocesoEstremos(0); return false;" href="#"><i class="fa fa-angle-double-left"></i></a></li>'; //id="AnteriorPaginadorExtremo"
    strHtmlPag +=
      '<li ><a data-toggle="tooltip" data-placement="bottom" title="Anterior" onclick="clickAvanceRetroceso(0); return false;" href="#"><i class="fa fa-angle-left"></i></a></li>'; //id="AnteriorPaginador"

    var pagDesde = ObtenerPaginaDesde(
      pagActual,
      cantPaginaTotal,
      LimiteDePaginador_const
    );
    var pagHasta = ObtenerPaginaHasta(
      pagDesde,
      pagActual,
      cantPaginaTotal,
      LimiteDePaginador_const
    ...
    for (var i = pagDesde; i < pagHasta; i++) {
      strHtmlPag +=
        ...
        '" ><a id="pag_' +
        i.toString() +
        '" onclick="clickPaginador(this); return false;" href="#" >' +
        i.toString() +
        "</a></li>";
    }
    ...
    // Siguiente
    strHtmlPag +=
      '<li><a data-toggle="tooltip" data-placement="bottom" title="Siguiente" onclick="clickAvanceRetroceso(1); return false;" href="#"><i class="fa fa-angle-right"></i></a></li>'; // id="SiguientePaginador"
    strHtmlPag +=
      '<li ><a data-toggle="tooltip" data-placement="bottom" title="Fin" onclick="clickAvanceRetrocesoEstremos(1); return false;" href="#"><i class="fa fa-angle-double-right"></i></a></li>'; //id="SiguientePaginadorExtremo"
    ...
    var pagDesde = ObtenerPaginaDesde(
      pagActual,
      cantPaginaTotal,
      Math.floor(LimiteDePaginador_const / 2)
    );
    var pagHasta = ObtenerPaginaHasta(
      pagDesde,
      pagActual,
