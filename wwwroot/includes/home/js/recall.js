...
function cargarReCallIndex() {
    if (listaRecallIndex != null) {
        ...
        strHtml += '<a class="btn_ver" href="recalls">VER LISTADO COMPLETO</a>';
...
function cargarReCall() {
    if (objRecall != null) {
        var strHtml = '';
        strHtml += '<div class="col-xs-12"><a class="btn_volver float-left" href="recalls"><i class="fa fa-play"></i>VOLVER AL LISTADO</a></div><div class="clear25"></div>';
        strHtml += '<div class="col-xs-12">';
        ...
        if (isNotNullEmpty(objRecall.arc_nombre)) {
            strHtml += '<div class="col-xs-12"><div class="clear25"></div><a class="btn_ampliar" href="../../servicios/descargarArchivo?t=recallpdf&n=' + objRecall.arc_nombre + '&inline=yes" target="_blank">VER COMUNICADO</a></div>';
        }
